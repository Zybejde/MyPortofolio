  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        {/* <p className='max-w-2xl mx-auto font-Ovo'>
            I am a Software Engineer with experience at Idealdevs.
        </p> */}
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            <a href="/sample-resume.pdf"download="Zybejde-Baraj-CV.pdf" className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>resume <Image src={assets.download_icon} alt='' className='w-4'/></a>
        </div>
    </div>
  )
}
